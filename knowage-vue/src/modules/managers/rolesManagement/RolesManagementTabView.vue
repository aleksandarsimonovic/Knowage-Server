                            ...
                            <div class="p-field" :style="rolesManagementTabViewDescriptor.pField.style">
                                <span class="p-float-label">
                                    <InputText
                                        ...
                                        :class="{
                                            'p-invalid': v$.selectedRole.name.$invalid && v$.selectedRole.name.$dirty
                                        }"
                            ...
                            <div class="p-field" :style="rolesManagementTabViewDescriptor.pField.style">
                                <span class="p-float-label">
                                    <InputText
                                        ...
                                        :class="{
                                            'p-invalid': v$.selectedRole.code.$invalid && v$.selectedRole.code.$dirty
                                        }"
                            ...
                            <div class="p-field" :style="rolesManagementTabViewDescriptor.pField.style">
                                <span class="p-float-label">
                                    <InputText
                                        ...
                                        :class="{
                                            'p-invalid': v$.selectedRole.description.$invalid && v$.selectedRole.description.$dirty
                                        }"
