<template>
  <Dialog
    :visible="true"
    :modal="true"
    class="kn-dialog--toolbar--primary"
    :header="formHeader"
    :closable="false"
    :style="configurationManagementDescriptor.form.style"
  >
      ...
      <div class="p-field" :style="configurationManagementDescriptor.pField.style">
        <span class="p-float-label">
          <InputText
            ...
            :class="{
              'p-invalid':
                v$.configuration.label.$invalid && v$.configuration.label.$dirty,
            }"
            maxLength="100"
            @blur="v$.configuration.label.$touch()"
          />
          <label for="label" class="kn-material-input-label">
            {{ $t("managers.configurationManagement.headers.label")}} *
          </label>
        </span>
      ...
      <div class="p-field" :style="configurationManagementDescriptor.pField.style">
        <span class="p-float-label">
          ...
          <label for="name" class="kn-material-input-label">
            {{ $t("managers.configurationManagement.headers.name")}} *
          </label>
        </span>
        <KnValidationMessages
      ...
      <div class="p-field" :style="configurationManagementDescriptor.pField.style">
        <span class="p-float-label">
          <InputText
            ...
            :class="{
              'p-invalid':
                v$.configuration.description.$invalid &&
                v$.configuration.description.$dirty,
            }"
            maxLength="500"
      ...
      <div class="p-field" :style="configurationManagementDescriptor.pField.style">
        <span class="p-float-label">
          <Dropdown
            ...
            :class="{
              'p-invalid':
                v$.configuration.category.$invalid && v$.configuration.category.$dirty,
            }"
          ...
          />
          <label for="category" class="kn-material-input-label">
            {{ $t("managers.configurationManagement.headers.category")}} *
          </label>
        </span>
        <KnValidationMessages
  ...
  validations() {
    return {
      configuration: {
        ...
        description: {
          maximumCharacters: maxLength(500),
          regex
        },
        active: {
          required,
  ...
  computed: {
    formHeader(): any {
      return this.configuration.id
        ...
        : this.$t("managers.configurationManagement.createNewHeader");
    },
    buttonDisabled(): any {
    ...
    async handleSubmit() {
      ...
      await this.sendRequest(url).then(() => {
        this.$store.commit("setInfo", {
          title: this.$t(
            this.configurationManagementDescriptor.operation[this.operation].toastTitle
          ),
